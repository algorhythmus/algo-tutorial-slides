...
\begin{frame}{Graphen durchlaufen – Aufgabe}
	\taskheading{Searching Facebook}
	Das Kleine-Welt-Phänomen besagt, dass jeder Mensch mit jedem anderen über maximal sechs Ecken bekannt ist.\\
	\medskip
	Wir betrachten einen \emph{Freundschaftsgraphen} eines beliebigen \thassedaniel{\enquote{Überwachungsnetzwerkes}}{Überwachungsnetzwerkes}, bei dem Menschen als Knoten und ihre Freundschaften als Kanten dargestellt sind.
