...
\begin{frame}{Orga-Kram – Übungsblätter}  %TODO
	\begin{itemize}
...
\begin{frame}{Fragen? Hilfe?}
	...
	Content:
	\begin{itemize}
		\item VL-Folien, Skript, Ü-Blätter...: im \ILIAS.
...
\begin{frame}{Pseudocode}
	\begin{exampleblock}{Arrays}
		\begin{algorithm}[H]
			Schema: \quad $ blupp : \KwArray[\textit{Von}..\textit{Bis}] \KwOf T $ \\
			Heißt: \quad $blupp$ ist ein $T$-\KwArray. Der erste Index ist \textit{Von}, der letzte ist \textit{Bis}. \\ 
			\forcenewline
			\pause
			Bsp.: \\ 
...
\begin{frame}{Pseudocode}
	\begin{exampleblock}{Mathe-Bequemlichkeit}
		...
		$\KwFor \KwEach x \in M \KwSty{ do}$ \\[0,125cm]
		$(a, b) := (3, 5)$ \quad // Tupel FTW! \smiley \\[0,125cm] 
		$(a, b) := (b, a)$ \quad // bequemes Vertauschen \\[0,125cm]
		$M := \{1, 2, 3\}$ \quad // ungeordnete Menge \\[0,125cm] %TODO: Sollen wir das überhaupt erwähnen?
		$S := \langle1, 2, 3\rangle$ \quad // geordnete Folge (Elemente können an- und abgehängt werden) %TODO: Sollen wir das überhaupt erwähnen?
	\end{exampleblock}
