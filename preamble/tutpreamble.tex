...
\newcommand{\morescalingdelimiters}{   % for proper \left( \right) typography
	\delimitershortfall=-1pt  % formerly: 0pt  
	\delimiterfactor=1
}
% todo later
...
\IfFileExists{images/logo.png}{
	\TitleImage[width=\titleimagewd]{images/logo}
}{}
...
\newcommand{\starttut}[1]{\setcounter{weeknum}{#1}\titleframe\frame{\frametitle{Inhalt}\tableofcontents} 
	\mycomment{
		\AtBeginSection[]{%
...
\newcommand{\ILIAS}{\urlnamed{http://tagesschau.de}{ILIAS}\xspace} %TODO
