...
\newcounter{tasknum}
\newcommand{\taskheading}[1]{\addtocounter{tasknum}{1}\textbf{Aufgabe \thetasknum: #1} \\}
\newcommand{\solutionheading}{\textbf{Lösung zu Aufgabe \thetasknum} \\}
...
% #1 number
% #2 title 
% #3 vspace (positive) without unit (pt)
\newcommand{\xkcdframe}[3]{
	\lastframetitled{.96\textwidth}{#3}{xkcd_#1}{http://xkcd.com/#1}{}{#2}
}
