...
\begin{headframe}[Des Informatikers liebstes Hobby] %TODO
	Sortieren
\end{headframe}
...
\begin{frame}[t]{Sortieren – untere Schranke}
	...
	\YesQuestion{Ist $\log(n!) \in \Theta(n\log n)$?} 
\end{frame}
...
\begin{frame}
	...
	\node[xshift=-1cm,yshift=-4.4cm] at (current page.north) {\includegraphics[height=.89\paperheight]{xkcd_ineffective_sorts_2x}};
	\end{tikzpicture}
\end{frame}
