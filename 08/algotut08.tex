...
\daniel{
	...
	\begin{frame}[t]{Quiz}
		\ContentQuestion{Wie viele Elemente kann ein Heap der Höhe $h$ minimal/maximal haben?}{Minimal $2\*(h-1)$, maximal $2h - 1$.}
		\NoQuestion{Ist das Array $(23, 17, 14, 6, 13, 10, 1, 5, 7, 12)$ ein Min-Heap?}
		\ContentQuestion{Wo befindet sich das kleinste Element im Max-Heap?}{In einem Blatt im untersten Level.}\smallskip
